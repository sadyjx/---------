...
/******************************************************************************
                            1:修改产品信息                
******************************************************************************/
#define PRODUCT_KEY "aklybyms"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//目标温度_F(可下发可上报)
//备注:
#define DPID_TEMP_SET_F 17
//设置温度上限-℉(可下发可上报)
//备注:
#define DPID_UPPER_TEMP_F 18
//设置温度上限(可下发可上报)
//备注:
#define DPID_UPPER_TEMP 19
//设置温度下限-℉(可下发可上报)
//备注:
#define DPID_LOWER_TEMP_F 20
//温标切换(可下发可上报)
//备注:
...
//设置温度下限(可下发可上报)
//备注:
#define DPID_LOWER_TEMP 26
//档位(可下发可上报)
//备注:
#define DPID_LEVEL 28
//当前温度_F(只上报)
//备注:
#define DPID_TEMP_CURRENT_F 29
//阀门状态(只上报)
//备注:
#define DPID_VALVE_STATE 36
...
extern unsigned char download_handle_sta;   //有操作信息
