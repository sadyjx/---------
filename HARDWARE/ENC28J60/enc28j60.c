...
//	GPIOA->CRL|=0X33000000;	//PG6/7 推挽 	    
	GPIOA->CRH&=0XFFFFFFF0; 
	GPIOA->CRH|=0X00000003;	//PA8 推挽 
	GPIOA->ODR|=1<<8;     	//PA8 上拉	    
//	GPIOA->ODR|=7<<6;    	//PG6/7/8 上拉
 	SPI2_Init();			//初始化SPI2
...
{		
	...
	//1 = 符合格式匹配条件的数据包将被接受
	//0 = 禁止过滤器
    //ENC28J60_Write(ERXFCON, ERXFCON_UCEN|ERXFCON_BCEN);
