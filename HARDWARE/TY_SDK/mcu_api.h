...
extern u8 df_stats_f;  //阀门  阀门状态0x00通风0x01冷阀0x02热阀
extern u16 set_t_num;
extern u8 open_on;     //0 开机 1 关机
extern u8 set_c_f;     // 0 摄氏度  1 华氏度
extern u16 wd_display;
extern u8 set_wd_upper_limit; // 设置温度上限  
extern u8 set_wd_lower_limit; // 设置温度下限 
extern u8 set_wd_upper_limit_f; // 设置温度上限  
extern u8 set_wd_lower_limit_f; // 设置温度下限 
 
extern u8  timing_min;		   //
extern u8  timing_hour;		   //
extern u8  zigbee_net;		   //  zigbee设备入网状态  0x00：设备为未入网状态  0x01：设备为已入网状态；	 0x02：设备网络状态异常；
extern u8   zigbee_rssi;	    //  设备网络信号强度
extern u8   zigbee_net_time;	    //  设备网络信道
extern u16  zigbee_beattim;      //  zigbee心跳时间，上传所有的状态
extern u8   sys_zigbee_use;	    //  1 使用ZigBee
